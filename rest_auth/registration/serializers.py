...
class RegisterSerializer(serializers.Serializer):
    ...
    def validate_referrer_number(self, data):
        ref_phone_number = data
        if not CustomUserProfile.objects.filter(phone_number=ref_phone_number).exists():
            raise serializers.ValidationError(
                _("No user is registered with this number"))
    ...
    def get_cleaned_data(self):
        return {
            ...
            'referrer_number': self.validated_data.get('referrer_number', ''),
        }
